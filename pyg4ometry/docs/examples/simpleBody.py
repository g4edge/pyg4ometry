...
def simpleBody(vtkViewer = True, stlWriter = True) :
    ...
    sphereSolid1    = _pyg.geant4.solid.Sphere('sphere1', 0, 75, 0, _np.pi*2, 0, _np.pi, nslice=20, nstack=20)
    ...
    uniPhysical1    = _pyg.geant4.PhysicalVolume([0,0,0],[200,0,0],uniLogical1, 'uniLogical1', worldLogical)
    ...
    uniPhysical2    = _pyg.geant4.PhysicalVolume([0,0,0],[200,-200,0],uniLogical2, 'uniLogical2', worldLogical)

    subSolid1       = _pyg.geant4.solid.Subtraction('sub1', intrSolid1, uniSolid2, [[0,0,0],[0,0,0]])
    subLogical1     = _pyg.geant4.LogicalVolume(subSolid1, 'G4_Cu', 'subLogical2')
    subPhysical1    = _pyg.geant4.PhysicalVolume([0,0,0],[0,200,0],subLogical1, 'subLogical1', worldLogical)
