...
def simpleBody(vtkViewer=True, stlWriter=True, gdmlWriter=True):
    ...
    sphereSolid1 = _pyg.geant4.solid.Sphere(
        "sphere1", 0, 75.0, 0, _np.pi * 2, 0, _np.pi, nslice=20, nstack=20
    )
    sphereLogical1 = _pyg.geant4.LogicalVolume(sphereSolid1, "G4_Cu", "sphereLogical1")
    spherePhysical1 = _pyg.geant4.PhysicalVolume(
        [0, 0, 0], [-200, -200, 0], sphereLogical1, "spherePhysical1", worldLogical
    )

    boxSolid1 = _pyg.geant4.solid.Box("box1", 60, 60, 60)
    boxLogical1 = _pyg.geant4.LogicalVolume(boxSolid1, "G4_Cu", "boxLogical1")
    boxPhysical1 = _pyg.geant4.PhysicalVolume(
        [0, 0, 0], [0, -200, 0], boxLogical1, "boxPhysical1", worldLogical
    )

    intrSolid1 = _pyg.geant4.solid.Intersection(
        "intr1", sphereSolid1, boxSolid1, [[0, 0, 0], [0, 0, 0]]
    )
    intrLogical1 = _pyg.geant4.LogicalVolume(intrSolid1, "G4_Cu", "intrLogical1")
    intrPhysical1 = _pyg.geant4.PhysicalVolume(
        [0, 0, 0], [0, 0, 0], intrLogical1, "intrPhysical1", worldLogical
    )
    ...
    tubsPhysical1 = _pyg.geant4.PhysicalVolume(
        [0, 0, 0], [-200, 0, 0], tubsLogical1, "tubsPhysical1", worldLogical
    )

    uniSolid1 = _pyg.geant4.solid.Union(
        "uni1", tubsSolid1, tubsSolid1, [[_np.pi / 2, 0, 0], [0, 0, 0]]
    )
    uniLogical1 = _pyg.geant4.LogicalVolume(uniSolid1, "G4_Cu", "uniLogical1")
    uniPhysical1 = _pyg.geant4.PhysicalVolume(
        [0, 0, 0], [200, 0, 0], uniLogical1, "uniPhysical1", worldLogical
    )

    uniSolid2 = _pyg.geant4.solid.Union(
        "uni2", tubsSolid1, uniSolid1, [[_np.pi / 2, _np.pi / 2, 0], [0, 0, 0]]
    )
    uniLogical2 = _pyg.geant4.LogicalVolume(uniSolid2, "G4_Cu", "uniLogical2")
    uniPhysical2 = _pyg.geant4.PhysicalVolume(
        [0, 0, 0], [200, -200, 0], uniLogical2, "uniPhysical2", worldLogical
    )

    subSolid1 = _pyg.geant4.solid.Subtraction(
        "sub1", intrSolid1, uniSolid2, [[0, 0, 0], [0, 0, 0]]
    )
    subLogical1 = _pyg.geant4.LogicalVolume(subSolid1, "G4_Cu", "subLogical1")
    subPhysical1 = _pyg.geant4.PhysicalVolume(
        [0, 0, 0], [0, 200, 0], subLogical1, "subPhysical1", worldLogical
    )
