...
def simpleCollimator(vtkViewer = True, gdmlWriter = True) :
    ...
    cj_material = "G4_Cu"
    ucj_position = _pyg.geant4.ParameterVector("ucj_position",[zero,ucj_yposition,zero])
    lcj_position = _pyg.geant4.ParameterVector("lcj_position",[zero,lcj_yposition,zero])
    ...
    cj_solid      = _pyg.geant4.solid.Trd("upper_collimator_jaw", cj_width, cj_width, cj_length1, cj_length2, cj_thick)
    cj_logical    = _pyg.geant4.LogicalVolume(cj_solid,cj_material,"cj_logical")
    ucj_physical   = _pyg.geant4.PhysicalVolume([-_math.pi/2.0,0,0],ucj_position,cj_logical,"ucj_physical",world_logical)
    lcj_physical   = _pyg.geant4.PhysicalVolume([_math.pi/2.0,0,0],lcj_position,cj_logical,"lcj_physical",world_logical)
