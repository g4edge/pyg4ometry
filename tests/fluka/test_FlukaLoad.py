...
def test_FlairLoad_T021_QUA(testdata):
    quaAABB = {"QUA_REG": _fluka.AABB([-150., 100., 0],
                                      [150., 200., 1000.])}
    flairLoadWriteTest(testdata["fluka/021_QUA.inp"], False, False,
...
def test_FlairLoad_T314_QUA_transform(testdata):
    ...
    flairLoadWriteTest(testdata["fluka/314_QUA_transform.inp"], False, False,
                       quadricRegionAABBs=quaAABB)
...
def test_FlairLoad_T514_QUA_expansion(testdata):
    ...
    flairLoadWriteTest(testdata["fluka/514_QUA_expansion.inp"], False, False,
                       quadricRegionAABBs=quaAABB)

def test_FlairLoad_T514_QUA_translation(testdata):
    quaAABB = {"QUA_REG": _fluka.AABB([-150., 100., -1000.],
                                      [150., 200., 0.])}
    flairLoadWriteTest(testdata["fluka/514_QUA_translation.inp"], False, False,
                       quadricRegionAABBs=quaAABB)

def test_FlairLoad_T514_QUA_rototranslation(testdata):
    quaAABB = {"QUA_REG": _fluka.AABB([-190., 40., 0], [50., 200., 1000.])}
    flairLoadWriteTest(testdata["fluka/514_QUA_rototranslation.inp"], False, False,
                       quadricRegionAABBs=quaAABB)
...
def test_FlairLoad_T514_QUA_coplanar(testdata):
    ...
    flairLoadWriteTest(testdata["fluka/514_QUA_coplanar.inp"], False, False,
                       quadricRegionAABBs=quaAABB)
...
def test_FlairLoad_T902_preprocessor_elif(testdata):
    freg, greg = flairLoadWriteTest(testdata["fluka/902_preprocessor_elif.inp"],
                                    False, False)
    solids = greg.solidDict
    assert(isinstance(solids["bb1_s"], pyg4ometry.geant4.solid.Box))

def test_FlairLoad_T903_preprocessor_else(testdata):
    freg, greg = flairLoadWriteTest(testdata["fluka/903_preprocessor_else.inp"],
                                    False, False)
    solids = greg.solidDict
...
def test_FlairLoad_T905_preprocessor_nested_if(testdata):
    freg, greg = flairLoadWriteTest(testdata["fluka/905_preprocessor_nested_if.inp"],
                       False, False)
    solids = greg.solidDict
    assert(isinstance(solids["bb1_s"], pyg4ometry.geant4.solid.Cons))

def test_FlairLoad_T906_preprocessor_nested_elif(testdata):
    freg, greg = flairLoadWriteTest(testdata["fluka/906_preprocessor_nested_elif.inp"],
                                    False, False)
    solids = greg.solidDict
    assert(isinstance(solids["bb1_s"], pyg4ometry.geant4.solid.Box))

def test_FlairLoad_T907_preprocessor_nested_else(testdata):
    freg, greg = flairLoadWriteTest(testdata["fluka/907_preprocessor_nested_else.inp"],
                                    False, False)
    solids = greg.solidDict
    assert(isinstance(solids["bb1_s"], pyg4ometry.geant4.solid.Box))
