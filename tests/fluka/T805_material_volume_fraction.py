...
def Test(vis=False, interactive=False):
    ...
    fr = Material("FRANCIUM", 87, 2, flukaregistry=freg)
    es = Material("EINSTEIN", 99, 8, flukaregistry=freg)

    fr2es3 = Compound(
        "Fr2Es3", 7.5, [(fr, 1.0), (es, 1.0)], fractionType="volume", flukaregistry=freg
    )
