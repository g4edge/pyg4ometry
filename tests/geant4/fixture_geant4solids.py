...
def geant4_tubs(registry):
    ...
    ts = _g4.solid.Tubs("ts",trmin,trmax,tz,tstartphi,tdeltaphi,registry, "mm","rad",nslice=16)
...
def geant4_cuttubs(registry):
    ...
    cts = _g4.solid.CutTubs("ts",
                            ctrmin,ctrmax,ctz,ctstartphi,ctdeltaphi,
                            [ctlowx,ctlowy,ctlowz],
                            [cthighx,cthighy,cthighz],
                            registry,"mm","rad",nslice=16)
    return cts
...
def geant4_cons(registry):
    ...
    cs = _g4.solid.Cons("cs",crmin1,crmax1,crmin2,crmax2,cz,zero,cdp,registry,"mm","rad",nslice=16)
...
def geant4_trap(registry):
    ...
    ts = _g4.solid.Trap("ts",tz,ttheta,tphi,ty1,tx1,tx2,talp1,ty2,tx3,tx4,talp2,registry,"mm","rad")
...
def geant4_sphere(registry):
    ...
    ss = _g4.solid.Sphere("ss",srmin,srmax,ssphi,sdphi,sstheta,sdtheta,registry,"mm","rad",nslice=16, nstack=16)
