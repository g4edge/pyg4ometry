...
def Test(vis=False, interactive=False, outputPath=None):
    ...
    l2 = T012_GenericPolycone.Test(vis=False, interactive=False, outputPath=outputPath)["logicalVolume"]
    ...
    w = _gd.Writer()
    w.addDetector(reg0)
    w.write(outputPath / "T412_MergeRegistry_GenericPolycone.gdml")
