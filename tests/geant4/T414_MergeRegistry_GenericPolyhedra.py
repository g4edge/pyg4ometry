...
def Test(vis=False, interactive=False, outputPath=None):
    ...
    l2 = T014_GenericPolyhedra.Test(vis=False, interactive=False, outputPath=outputPath)["logicalVolume"]
    ...
    w = _gd.Writer()
    w.addDetector(reg0)
    w.write(outputPath / "T414_MergeRegistry_GenericPolyhedra.gdml")
