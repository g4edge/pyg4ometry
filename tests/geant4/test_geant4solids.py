...
def test_PythonGeant_T001_Box(tmptestdir):
    T001_Box.Test(vis=False, interactive=False, writeNISTMaterials=writeNISTMaterials, outputPath=tmptestdir)


def test_PythonGeant_T002_Tubs(tmptestdir):
    T002_Tubs.Test(vis=False, interactive=False, writeNISTMaterials=writeNISTMaterials, outputPath=tmptestdir)


def test_PythonGeant_T003_CutTubs(tmptestdir):
    T003_CutTubs.Test(vis=False, interactive=False, type=T003_CutTubs.normal,
                      writeNISTMaterials=writeNISTMaterials, outputPath=tmptestdir)
    T003_CutTubs.Test(vis=False, interactive=False, type=T003_CutTubs.flat_ends,
...
def test_PythonGeant_T004_Cons(tmptestdir):
    ...
    try:
        T004_Cons.Test(vis=False, interactive=False, type=T004_Cons.r2min_gt_r2max, outputPath=tmptestdir)
    except ValueError:
        pass

    try:
        T004_Cons.Test(vis=False, interactive=False, type=T004_Cons.dphi_gt_2pi,outputPath=tmptestdir)
    except ValueError:
        pass
    ...
    T004_Cons.Test(vis=False, interactive=False, type=T004_Cons.inner_cylinder, outputPath=tmptestdir)

    T004_Cons.Test(vis=False, interactive=False,outputPath=tmptestdir)


def test_PythonGeant_T005_Para(tmptestdir):
    T005_Para.Test(vis=False, interactive=False,
                    writeNISTMaterials=writeNISTMaterials,
                    outputPath=tmptestdir)


def test_PythonGeant_T006_Trd(tmptestdir):
    T006_Trd.Test(vis=False, interactive=False,
                  writeNISTMaterials=writeNISTMaterials,
                  outputPath=tmptestdir,
                  )
...
def test_PythonGeant_T007_Trap(tmptestdir):
    T007_Trap.Test(vis=False, interactive=False,
                   writeNISTMaterials=writeNISTMaterials,
                   outputPath=tmptestdir)


def test_PythonGeant_T008_Sphere(tmptestdir):
    assert T008_Sphere.Test(vis=False, interactive=False,
                            writeNISTMaterials=writeNISTMaterials,
                            outputPath=tmptestdir)


def test_PythonGeant_T009_Orb(tmptestdir):
    T009_Orb.Test(vis=False, interactive=False,
                  writeNISTMaterials=writeNISTMaterials,
                  outputPath=tmptestdir)


def test_PythonGeant_T010_Torus(tmptestdir):
    T010_Torus.Test(vis=False, interactive=False,
                    writeNISTMaterials=writeNISTMaterials,
                    outputPath=tmptestdir)


def test_PythonGeant_T011_Polycone(tmptestdir):
    T011_Polycone.Test(vis=False, interactive=False,
                       writeNISTMaterials=writeNISTMaterials,
                       outputPath=tmptestdir)


def test_PythonGeant_T012_GenericPolycone(tmptestdir):
    T012_GenericPolycone.Test(vis=False, interactive=False, type=T012_GenericPolycone.normal,
                              writeNISTMaterials=writeNISTMaterials,
                              outputPath=tmptestdir
                              )

    try:
        T012_GenericPolycone.Test(vis=False, interactive=False, type=T012_GenericPolycone.two_planes,
                                  outputPath=tmptestdir
                                  )
    except ValueError:
        pass
...
def test_PythonGeant_T013_Polyhedra(tmptestdir):
    T013_Polyhedra.Test(vis=False, interactive=False,
                        writeNISTMaterials=writeNISTMaterials,
                        outputPath=tmptestdir)
...
def test_PythonGeant_T016_Ellipsoid(tmptestdir):
    assert T016_Ellipsoid.Test(vis=False,
                               interactive=False,
                               writeNISTMaterials=writeNISTMaterials,
                               outputPath=tmptestdir)
...
def test_PythonGeant_T018_Paraboloid(tmptestdir):
    T018_Paraboloid.Test(vis=False,
                         interactive=False,
                         writeNISTMaterials=writeNISTMaterials,
                         outputPath=tmptestdir)
...
def test_PythonGeant_T019_Hyperboloid(tmptestdir):
    T019_Hyperboloid.Test(vis=False,
                          interactive=False,
...
def test_PythonGeant_T021_ExtrudedSolid(tmptestdir):
    T021_ExtrudedSolid.Test(vis=False,
                            interactive=False,
                            writeNISTMaterials=writeNISTMaterials,
                            outputPath=tmptestdir)
...
def test_PythonGeant_T022_TwistedBox(tmptestdir):
    T022_TwistedBox.Test(vis=False,
                         interactive=False,
                         writeNISTMaterials=writeNISTMaterials,
                         outputPath=tmptestdir)
...
def test_PythonGeant_T023_TwistedTrap(tmptestdir):
    T023_TwistedTrap.Test(vis=False,
                          interactive=False,
                          writeNISTMaterials=writeNISTMaterials,
                          outputPath=tmptestdir)
...
def test_PythonGeant_T024_TwistedTrd(tmptestdir):
    T024_TwistedTrd.Test(vis=False,
                         interactive=False,
                         writeNISTMaterials=writeNISTMaterials,
                         outputPath=tmptestdir)
...
def test_PythonGeant_T025_TwistedTubs(tmptestdir):
    T025_TwistedTubs.Test(vis=False,
                          interactive=False,
                          writeNISTMaterials=writeNISTMaterials,
                          outputPath=tmptestdir)
...
def test_PythonGeant_T026_GenericTrap(tmptestdir):
    T026_GenericTrap.Test(vis=False,
                          interactive=False,
                          writeNISTMaterials=writeNISTMaterials,
                          outputPath=tmptestdir)
...
def test_PythonGeant_T029_Subtraction(tmptestdir):
    T029_Subtraction.Test(vis=False,
                          interactive=False,
                          nullMesh=False,
                          writeNISTMaterials=writeNISTMaterials,
                          outputPath=tmptestdir)
...
def test_PythonGeant_T030_Intersection(tmptestdir):
    T030_Intersection.Test(vis=False,
                           interactive=False,
...
def test_PythonGeant_T031_MultiUnion(tmptestdir):
    T031_MultiUnion.Test(vis=False,
                         interactive=False,
                         writeNISTMaterials=writeNISTMaterials,
                         outputPath=tmptestdir)
...
def test_PythonGeant_T033_Tessellated(tmptestdir):
    T033_TessellatedSolid.Test(vis=False,
                               interactive=False,
                               writeNISTMaterials=writeNISTMaterials,
                               outputPath=tmptestdir)
