...
def test_GdmlLoad_112_ParameterisedVolume_tube(testdata):
    registry, writtenFilename = pyg4ometryLoadWriteTest(testdata["gdml/112_parameterised_tube.gdml"])
    assert(geant4LoadTest(writtenFilename))
...
def test_GdmlLoad_113_ParameterisedVolume_cone(testdata):
    registry, writtenFilename = pyg4ometryLoadWriteTest(testdata["gdml/113_parameterised_cone.gdml"])
    assert(geant4LoadTest(writtenFilename))
...
def test_GdmlLoad_115_ParameterisedVolume_sphere(testdata):
    registry, writtenFilename = pyg4ometryLoadWriteTest(testdata["gdml/115_parameterised_sphere.gdml"])
    assert(geant4LoadTest(writtenFilename)) # Faulty in Geant4
...
def test_GdmlLoad_116_ParameterisedVolume_torus(testdata):
    registry, writtenFilename = pyg4ometryLoadWriteTest(testdata["gdml/116_parameterised_torus.gdml"])
    assert(geant4LoadTest(writtenFilename))
...
def test_GdmlLoad_117_ParameterisedVolume_hype(testdata):
    registry, writtenFilename = pyg4ometryLoadWriteTest(testdata["gdml/117_parameterised_hype.gdml"])
    assert(geant4LoadTest(writtenFilename))
...
def test_GdmlLoad_118_ParameterisedVolume_para(testdata):
    registry, writtenFilename = pyg4ometryLoadWriteTest(testdata["gdml/118_parameterised_para.gdml"])
    assert(geant4LoadTest(writtenFilename))
...
def test_GdmlLoad_120_ParameterisedVolume_trap(testdata):
    registry, writtenFilename = pyg4ometryLoadWriteTest(testdata["gdml/120_parameterised_trap.gdml"])
    assert(geant4LoadTest(writtenFilename))
...
def test_GdmlLoad_121_ParameterisedVolume_polycone(testdata):
    registry, writtenFilename = pyg4ometryLoadWriteTest(testdata["gdml/121_parameterised_polycone.gdml"])
    assert(geant4LoadTest(writtenFilename))
...
def test_GdmlLoad_122_ParameterisedVolume_polyhedron(testdata):
    registry, writtenFilename = pyg4ometryLoadWriteTest(testdata["gdml/122_parameterised_polyhedron.gdml"])
    assert(geant4LoadTest(writtenFilename))
...
def test_GdmlLoad_123_ParameterisedVolume_ellipsoid(testdata):
    registry, writtenFilename = pyg4ometryLoadWriteTest(testdata["gdml/123_parameterised_ellipsoid.gdml"])
    assert(geant4LoadTest(writtenFilename))
...
def test_GdmlLoad_139_DivisionVolume_polycone_rho(testdata):
    registry, writtenFilename = pyg4ometryLoadWriteTest(testdata["gdml/139_division_polycone_rho.gdml"])
    #assert(geant4LoadTest(writtenFilename)) # Faulty in Geant4
...
def test_GdmlLoad_140_DivisionVolume_polycone_phi(testdata):
    registry, writtenFilename = pyg4ometryLoadWriteTest(testdata["gdml/140_division_polycone_phi.gdml"])
...
def test_GdmlLoad_141_DivisionVolume_polycone_z(testdata):
    registry, writtenFilename = pyg4ometryLoadWriteTest(testdata["gdml/141_division_polycone_z.gdml"])
    #assert(geant4LoadTest(writtenFilename)) # Faulty in Geant4
...
def test_GdmlLoad_142_DivisionVolume_polyhedra_rho(testdata):
    registry, writtenFilename = pyg4ometryLoadWriteTest(testdata["gdml/142_division_polyhedra_rho.gdml"])
    #assert(geant4LoadTest(writtenFilename)) # Faulty in Geant4
...
def test_GdmlLoad_143_DivisionVolume_polyhedra_phi(testdata):
    registry, writtenFilename = pyg4ometryLoadWriteTest(testdata["gdml/143_division_polyhedra_phi.gdml"])
    #assert(geant4LoadTest(writtenFilename))   # Faulty in Geant4
...
def test_GdmlLoad_144_DivisionVolume_polyhedra_z(testdata):
    registry, writtenFilename = pyg4ometryLoadWriteTest(testdata["gdml/144_division_polyhedra_z.gdml"])
    #assert(geant4LoadTest(writtenFilename)) # Faulty in Geant4
