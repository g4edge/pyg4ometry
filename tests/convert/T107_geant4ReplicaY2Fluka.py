...
def Test(vis=False, interactive=False, fluka=False, outputPath=None):
    ...
    w = _gd.Writer()
    w.addDetector(reg)
    w.write(outputPath / "T107_geant4ReplicaY2Fluka.gdml")
    ...
    testDataPath = g4td["convert/T107_geant4ReplicaY2Fluka.inp"]
    assert _fc.cmp(testDataPath, outputPath / "T107_geant4ReplicaY2Fluka.inp")
