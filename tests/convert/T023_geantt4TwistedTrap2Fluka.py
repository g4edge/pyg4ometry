...
def Test(vis=False, interactive=False, fluka=True, outputPath=None):
    ...
    if fluka:
        ...
        w = _fluka.Writer()
        w.addDetector(freg)
        w.write(outputPath / "T023_geant4TwistedTrap2Fluka.inp")
    ...
    testDataPath = g4td["convert/T023_geant4TwistedTrap2Fluka.inp"]
    assert _fc.cmp(testDataPath, outputPath / "T023_geant4TwistedTrap2Fluka.inp")
