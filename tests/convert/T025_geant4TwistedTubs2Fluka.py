...
def Test(vis=False, interactive=False, fluka=True, outputPath=None):
    ...
    if fluka:
        ...
        w = _fluka.Writer()
        w.addDetector(freg)
        w.write(outputPath / "T025_geant4TwistedTubs2Fluka.inp")
    ...
    testDataPath = g4td["convert/T025_geant4TwiistedTubs2Fluka.inp"]
    assert _fc.cmp(testDataPath, outputPath / "T025_geant4TwiistedTubs2Fluka.inp")
