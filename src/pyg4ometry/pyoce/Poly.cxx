...
#else
    .def(py::init([](const Standard_Integer a1, const Standard_Integer a2, const Standard_Boolean a3, const Standard_Boolean) {
        return std::unique_ptr<Poly_Triangulation>(return new Poly_Triangulation(a1,a2,a3));
    }))
#endif
