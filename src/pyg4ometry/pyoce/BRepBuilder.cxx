...
PYBIND11_MODULE(BRepBuilder, m) {
  ...
  py::class_<BRepBuilderAPI_MakeVertex, BRepBuilderAPI_MakeShape>(m, "BRepBuilderAPI_MakeVertex")
  .def(py::init<const gp_Pnt&>())
  .def("Vertex",&BRepBuilderAPI_MakeVertex::Vertex);

  py::class_<BRepBuilderAPI_MakeEdge, BRepBuilderAPI_MakeShape>(m, "BRepBuilderAPI_MakeEdge")
  .def(py::init<>());

  py::class_<BRepBuilderAPI_MakeWire, BRepBuilderAPI_MakeShape>(m, "BRepBuilderAPI_MakeWire")
  .def(py::init<>());

  py::class_<BRepBuilderAPI_MakePolygon, BRepBuilderAPI_MakeShape>(m, "BRepBuilderAPI_MakePolygon")
  ...
  py::class_<BRepBuilderAPI_MakeFace, BRepBuilderAPI_MakeShape>(m, "BRepBuilderAPI_MakeFace")
  .def(py::init<>())
  .def(py::init<const TopoDS_Wire &, const Standard_Boolean /*OnlyPlane*/ >());
  ...
  .def(py::init<const Standard_Real /*tolerance=1.0e-06*/, const Standard_Boolean /*option1=Standard_True*/,
                const Standard_Boolean /*option2=Standard_True*/, const Standard_Boolean /*option3=Standard_True*/,
