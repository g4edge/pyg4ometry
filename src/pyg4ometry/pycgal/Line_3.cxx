...
PYBIND11_MODULE(Line_3, m) {
  py::class_<Line_3_EPICK>(m,"Line_3_EPICK")
    ...
    /* Operations */
    .def("__eq__",[](const Line_3_EPICK &l1, const Line_3_EPICK &l2) {return l1 == l2;})
    .def("__ne__",[](const Line_3_EPICK &l1, const Line_3_EPICK &l2) {return l1 != l2;})
    .def("projection",&Line_3_EPICK::projection)
    .def("point",[](const Line_3_EPICK &l1, const Kernel_EPICK::FT i) {return l1.point(i);})
    .def("point",[](const Line_3_EPICK &l1, const double i) {return l1.point(i);})
  ...
  py::class_<Line_3_EPECK>(m,"Line_3_EPECK")
    ...
    /* Operations */
    .def("__eq__",[](const Line_3_EPECK &l1, const Line_3_EPECK &l2) {return l1 == l2;})
    .def("__ne__",[](const Line_3_EPECK &l1, const Line_3_EPECK &l2) {return l1 != l2;})
    .def("projection",&Line_3_EPECK::projection)
    .def("point",[](const Line_3_EPECK &l1, const Kernel_EPECK::FT i) {return l1.point(i);})
    .def("point",[](const Line_3_EPECK &l1, const double i) {return l1.point(i);})
