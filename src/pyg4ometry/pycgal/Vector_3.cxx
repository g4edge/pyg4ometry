...
PYBIND11_MODULE(Vector_3, m) {
  py::class_<Vector_3_EPICK>(m,"Vector_3_EPICK")
    ...
    .def("squared_length",[](Vector_3_EPICK &v3) {return v3.squared_length();})
    .def("__rmul__",[](const Kernel_EPICK::RT &s,Vector_3_EPICK &v) {return s*v;})
    .def("__rmul__",[](const Kernel_EPICK::FT &s,Vector_3_EPICK &v) {return s*v;})
    .def("__mul__",[](Vector_3_EPICK &v,const Kernel_EPICK::RT &s) {return s*v;})
    .def("__mul__",[](Vector_3_EPICK &v,const Kernel_EPICK::FT &s) {return s*v;})
    ...
    .def(py::init<const Kernel_EPICK::FT ,const Kernel_EPICK::FT, const Kernel_EPICK::FT>())
    ...
    .def("cartesian_begin",[](Vector_3_EPICK &v3){std::cout << "use cartesian_iter\n";})
    .def("cartesian_end",[](Vector_3_EPICK &v3){std::cout << "use cartesian_iter\n";})
    .def("cartesian_iter",[](Vector_3_EPICK &v3){return py::make_iterator(v3.cartesian_begin(),v3.cartesian_end());}, py::keep_alive<0, 1>())
    .def("dimension",&Vector_3_EPICK::dimension)
    .def("transform",&Vector_3_EPICK::transform)
    .def("direction",&Vector_3_EPICK::direction)

    /* Operators */
    .def("__eq__",[](const Vector_3_EPICK &v1, const Vector_3_EPICK &v2){return v1 == v2;})
    .def("__ne__",[](const Vector_3_EPICK &v1, const Vector_3_EPICK &v2){return v1 != v2;})
    .def("__add__",[](const Vector_3_EPICK &v1, const Vector_3_EPICK &v2){return v1+v2;})
    .def("__add__",[](const Vector_3_EPICK &v1, const Vector_3_EPICK &v2){return v1+v2;})
    .def("__iadd__",[]( Vector_3_EPICK &v1, const Vector_3_EPICK &v2){v1+=v2; return v1;})
    .def("__sub__",[](const Vector_3_EPICK &v1, const Vector_3_EPICK &v2){return v1-v2;})
    .def("__isub__",[]( Vector_3_EPICK &v1, const Vector_3_EPICK &v2){v1-=v2; return v1;})
  ...
  py::class_<Vector_3_EPECK>(m,"Vector_3_EPECK")
    ...
    .def("__rmul__",[](const Kernel_EPECK::RT &s,Vector_3_EPECK &v) {return s*v;})
    .def("__rmul__",[](const Kernel_EPECK::FT &s,Vector_3_EPECK &v) {return s*v;})
    .def("__mul__",[](Vector_3_EPECK &v,const Kernel_EPECK::RT &s) {return s*v;})
    .def("__mul__",[](Vector_3_EPECK &v,const Kernel_EPECK::FT &s) {return s*v;})
    ...
    .def(py::init<const Kernel_EPECK::FT ,const Kernel_EPECK::FT, const Kernel_EPECK::FT>())
    ...
    /* Operators */
    .def("__eq__",[](const Vector_3_EPECK &v1, const Vector_3_EPECK &v2){return v1 == v2;})
    .def("__ne__",[](const Vector_3_EPECK &v1, const Vector_3_EPECK &v2){return v1 != v2;})
    .def("__add__",[](const Vector_3_EPECK &v1, const Vector_3_EPECK &v2){return v1+v2;})
    .def("__add__",[](const Vector_3_EPECK &v1, const Vector_3_EPECK &v2){return v1+v2;})
    .def("__iadd__",[]( Vector_3_EPECK &v1, const Vector_3_EPECK &v2){v1+=v2; return v1;})
    .def("__sub__",[](const Vector_3_EPECK &v1, const Vector_3_EPECK &v2){return v1-v2;})
    .def("__isub__",[]( Vector_3_EPECK &v1, const Vector_3_EPECK &v2){v1-=v2; return v1;})
