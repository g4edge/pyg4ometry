...
PYBIND11_MODULE(Triangle_3, m) {
  py::class_<Triangle_3_EPICK>(m,"Triangle_3_EPICK")
    ...
    /* Operations */
    .def("__eq__",[](Triangle_3_EPICK &t1, Triangle_3_EPICK &t2) { return t1 == t2;})
    .def("__ne__",[](Triangle_3_EPICK &t1, Triangle_3_EPICK &t2) { return t1 != t2;})
  ...
  py::class_<Triangle_3_EPECK>(m,"Triangle_3_EPECK")
    ...
    /* Operations */
    .def("__eq__",[](Triangle_3_EPECK &t1, Triangle_3_EPECK &t2) { return t1 == t2;})
    .def("__ne__",[](Triangle_3_EPECK &t1, Triangle_3_EPECK &t2) { return t1 != t2;})
