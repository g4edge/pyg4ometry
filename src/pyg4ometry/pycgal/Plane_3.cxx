...
PYBIND11_MODULE(Plane_3, m) {
  py::class_<Plane_3_EPICK>(m,"Plane_3_EPICK")
    ...
    .def(py::init<const Kernel_EPICK::Point_3, const Kernel_EPICK::Point_3, const Kernel_EPICK::Point_3>())
    .def(py::init<const Kernel_EPICK::Point_3, const Kernel_EPICK::Vector_3>())
    .def(py::init<const Kernel_EPICK::Point_3, const Kernel_EPICK::Direction_3>())
    ...
    .def(py::init<const Kernel_EPICK::Segment_3, const Kernel_EPICK::Point_3>())
    .def(py::init<const Kernel_EPICK::Circle_3>())

    /* operations */
    .def("__eq__",[](Plane_3_EPICK &p1, const Plane_3_EPICK p2){return p1 == p2;})
    .def("__ne__",[](Plane_3_EPICK &p1, const Plane_3_EPICK p2){return p1 != p2;})
    ...
    .def("has_on",[](const Plane_3_EPICK &pl, const Kernel_EPICK::Point_3 po) {return pl.has_on(po);})
    .def("has_on_positive_side",&Plane_3_EPICK::has_on_positive_side)
    .def("has_on_negative_side",&Plane_3_EPICK::has_on_negative_side)
    .def("has_on",[](const Plane_3_EPICK &pl, const Kernel_EPICK::Line_3 li) {return pl.has_on(li);})
    .def("has_on",[](const Plane_3_EPICK &pl, const Kernel_EPICK::Circle_3 ci) {return pl.has_on(ci);})
  ...
  py::class_<Plane_3_EPECK>(m,"Plane_3_EPECK")
    ...
    .def(py::init<const Kernel_EPECK::Point_3, const Kernel_EPECK::Point_3, const Kernel_EPECK::Point_3>())
    .def(py::init<const Kernel_EPECK::Point_3, const Kernel_EPECK::Vector_3>())
    .def(py::init<const Kernel_EPECK::Point_3, const Kernel_EPECK::Direction_3>())
    ...
    .def(py::init<const Kernel_EPECK::Segment_3, const Kernel_EPECK::Point_3>())
    .def(py::init<const Kernel_EPECK::Circle_3>())

    /* operations */
    .def("__eq__",[](Plane_3_EPECK &p1, const Plane_3_EPECK p2){return p1 == p2;})
    .def("__ne__",[](Plane_3_EPECK &p1, const Plane_3_EPECK p2){return p1 != p2;})
    ...
    /* Convenience Boolean Functions */
    .def("has_on",[](const Plane_3_EPECK &pl, const Kernel_EPECK::Point_3 po) {return pl.has_on(po);})
    .def("has_on_positive_side",&Plane_3_EPECK::has_on_positive_side)
    .def("has_on_negative_side",&Plane_3_EPECK::has_on_negative_side)
    .def("has_on",[](const Plane_3_EPECK &pl, const Kernel_EPECK::Line_3 li) {return pl.has_on(li);})
    .def("has_on",[](const Plane_3_EPECK &pl, const Kernel_EPECK::Circle_3 ci) {return pl.has_on(ci);})
