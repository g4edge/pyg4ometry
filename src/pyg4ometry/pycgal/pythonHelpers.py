...
def draw_polygon_2(p2):
    ...
    if type(p2) == _pyg4.pycgal.Polygon_2.Polygon_2_EPECK or \
       type(p2) == _pyg4.pycgal.Polygon_2.Polygon_2_EPICK:
        ...
        for p in p2 :
            draw_polygon_2(p)
    elif type(p2) == _pyg4.pycgal.Partition_traits_2_Polygon_2.Partition_traits_2_Polygon_2_EPECK or  \
         type(p2) == _pyg4.pycgal.Partition_traits_2_Polygon_2.Partition_traits_2_Polygon_2_EPICK :
        _draw_polygon_2(p2)
    else :
