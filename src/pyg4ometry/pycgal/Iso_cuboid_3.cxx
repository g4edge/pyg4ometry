...
PYBIND11_MODULE(Iso_cuboid_3, m) {
  ...
  /* related functions */
    .def("__eq__",[](const Iso_cuboid_3_EPICK &c1, const Iso_cuboid_3_EPICK &c2) {return c1 == c2;})
    .def("__ne__",[](const Iso_cuboid_3_EPICK &c1, const Iso_cuboid_3_EPICK &c2) {return c1 != c2;})

  /* creation */
    .def(py::init<const Kernel_EPICK::Point_3 &, const Kernel_EPICK::Point_3 &>())
    .def(py::init<const Kernel_EPICK::Point_3 &, const Kernel_EPICK::Point_3 &, int>())
    .def(py::init<const Kernel_EPICK::Point_3 &, const Kernel_EPICK::Point_3 &,
  ...
  /* Operations */
    ...
    .def("__getitem__",[](const Iso_cuboid_3_EPICK &c1, const int i) {return c1[i];})
  ...
  /* Operations */
    ...
    .def("__getitem__",[](const Iso_cuboid_3_EPECK &c1, const int i) {return c1[i];})
