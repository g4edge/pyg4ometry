...
PYBIND11_MODULE(Direction_3, m) {
  ...
  py::class_<Direction_3_EPICK>(m,"Direction_3_EPICK")
    ...
    .def("__eq__",[](const Direction_3_EPICK &d1, const Direction_3_EPICK &d2){return d1 == d2;})
  ...
  py::class_<Direction_3_EPECK>(m,"Direction_3_EPECK")
    ...
    .def("__eq__",[](const Direction_3_EPECK &d1, const Direction_3_EPECK &d2){return d1 == d2;})
