...
PYBIND11_MODULE(Partition_traits_2_Polygon_2, m) {
  ...
  py::class_<Partition_traits_2_Polygon_2_EPICK>(m,"Partition_traits_2_Polygon_2_EPICK")
    .def(py::init<>())
    .def("size",&Partition_traits_2_Polygon_2_EPICK::size)
    .def("push_back",&Partition_traits_2_Polygon_2_EPICK::push_back)
    /* Random access methods */
    .def("vertex",[](Partition_traits_2_Polygon_2_EPICK &pg, std::size_t i) {return pg.vertex(i);});
  py::bind_vector<std::vector<Partition_traits_2_Polygon_2_EPICK>>(m, "List_Polygon_2_EPICK");

  py::class_<Partition_traits_2_Polygon_2_EPECK>(m,"Partition_traits_2_Polygon_2_EPECK")
    .def(py::init<>())
    .def("size",&Partition_traits_2_Polygon_2_EPECK::size)
    .def("push_back",&Partition_traits_2_Polygon_2_EPECK::push_back)
    /* Random access methods */
    .def("vertex",[](Partition_traits_2_Polygon_2_EPECK &pg, std::size_t i) {return pg.vertex(i);});
  py::bind_vector<std::vector<Partition_traits_2_Polygon_2_EPECK>>(m, "List_Polygon_2_EPECK");

  m.def("optimal_convex_partition_2",[](Partition_traits_2_Polygon_2_EPECK &polygon, std::vector<Partition_traits_2_Polygon_2_EPECK> &partition_polys)
  {
