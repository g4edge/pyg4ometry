...
PYBIND11_MODULE(Ray_3, m) {
  py::class_<Ray_3_EPICK>(m,"Ray_3_EPICK")
    ...
    .def(py::init<const Kernel_EPICK::Point_3 &, const Kernel_EPICK::Line_3 &>())

    /* Operations */
    .def("__eq__",[](const Ray_3_EPICK &r1, const Ray_3_EPICK &r2) {return r1 == r2;})
    .def("__ne__",[](const Ray_3_EPICK &r1, const Ray_3_EPICK &r2) {return r1 != r2;})
  ...
  py::class_<Ray_3_EPECK>(m,"Ray_3_EPECK")
    ...
    .def(py::init<const Kernel_EPECK::Point_3 &, const Kernel_EPECK::Line_3 &>())

    /* Operations */
    .def("__eq__",[](const Ray_3_EPECK &r1, const Ray_3_EPECK &r2) {return r1 == r2;})
    .def("__ne__",[](const Ray_3_EPECK &r1, const Ray_3_EPECK &r2) {return r1 != r2;})
