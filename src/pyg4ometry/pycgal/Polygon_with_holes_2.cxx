...
typedef CGAL::General_polygon_with_holes_2<Kernel_EPICK> General_polygon_with_holes_2_EPECK;
...
PYBIND11_MODULE(Polygon_with_holes_2, m) {
  py::class_<Polygon_with_holes_2_EPICK>(m, "Polygon_with_holes_2_EPICK")
      ...
      .def("add_hole", [](Polygon_with_holes_2_EPICK &ph, Polygon_2_EPICK &pa) {return ph.add_hole(pa);})
      .def("outer_boundary",
  ...
  py::class_<Polygon_with_holes_2_EPECK>(m, "Polygon_with_holes_2_EPECK")
      ...
      .def("add_hole", [](Polygon_with_holes_2_EPECK &ph, Polygon_2_EPECK &pa) {return ph.add_hole(pa);})
      .def("outer_boundary",
